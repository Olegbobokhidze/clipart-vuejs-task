...
<template>
  ...
  >
    ...
    <div class="flex h-full w-full flex-col gap-6 tablet:flex-row tablet:gap-8" v-if="width < 1240">
      <HomeAllNews />
      <HomePopularNews />
    </div>
    ...
    <div v-else class="flex h-full w-full flex-col gap-6 small:gap-12 large:gap-[4.125rem]">
      <HomeFamousFacts />
      <HomeBlogs />
    </div>
  </div>
